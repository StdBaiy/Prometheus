...
void YoloObjectDetector::init() {
  ...
  objectPublisher_ =
      nodeHandle_.advertise<prometheus_msgs::ObjectCount>(objectDetectorTopicName, objectDetectorQueueSize, objectDetectorLatch);
  boundingBoxesPublisher_ =
      nodeHandle_.advertise<prometheus_msgs::BoundingBoxes>(boundingBoxesTopicName, boundingBoxesQueueSize, boundingBoxesLatch);
...
void YoloObjectDetector::checkForObjectsActionGoalCB() {
  ...
  boost::shared_ptr<const prometheus_msgs::CheckForObjectsGoal> imageActionPtr = checkForObjectsActionServer_->acceptNewGoal();
...
void* YoloObjectDetector::publishInThread() {
  ...
  if (num > 0 && num <= 100) {
    ...
    prometheus_msgs::ObjectCount msg;
